    ...
    return (
        ...
        <Grid container className={'content'}>
            ...
            <Grid item className='inner-content'>
                ...
                >
                    The TextNinja app was built in order to help children’s to Improv their reading abilities in an efficient and convenient way.
                    ...
                    *ul
                        ...
                        *li Automatic Split words into syllables . */li
                        *li text to speech - On a click of a button you can hear a recording of the word. */li
                        *li The users can login locally or via Facebook / Google authentication,
                            track their own progress and practice the words they have difficulty with. */li
                        *li Simple & easy to use - the UI is built with Material design for a better UX. */li
                    */ul
                </TextNinjaTool>
